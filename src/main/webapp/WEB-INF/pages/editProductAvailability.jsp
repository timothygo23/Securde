...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="login">
				<form action="${pageContext.request.contextPath}/update_product_availability" method="post">
					<div class="col-md-6 login-do">
					
						<input type="hidden" name="product_id" value="${product_id}"/>
						<input type="hidden" name="product_avail_id_small" value="${small.product_avail_id}"/>
						<input type="hidden" name="product_avail_id_medium" value="${medium.product_avail_id}"/>
						<input type="hidden" name="product_avail_id_large" value="${large.product_avail_id}"/>
					
						<span>Small</span>
						<div class="login-mail">
							<input type="text" name="quantity_s" placeholder="Quantity" value = "${small.quantity}" required="" pattern="[0-9]+" oninvalid="SpecialCharInvalidMsg(this)">
						</div>
						
						<span>Medium</span>
						<div class="login-mail">
							<input type="text" name="quantity_m" placeholder="Quantity" value = "${medium.quantity}" required="" pattern="[0-9]+" oninvalid="SpecialCharInvalidMsg(this)">
						</div>
						
						<span>Large</span>
						<div class="login-mail">
							<input type="text" name="quantity_l" placeholder="Quantity" value = "${large.quantity}" required="" pattern="[0-9]+" oninvalid="SpecialCharInvalidMsg(this)">
						</div>
